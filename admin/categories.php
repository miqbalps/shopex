        ...
        <div class="flex-1">
            ...
            <div class="flex-1 bg-white p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="add_category.php" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg">
                                ...
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <a href="delete_category.php?id=<?php echo $row['id']; ?>" class="text-red-500 hover:text-red-700" 
